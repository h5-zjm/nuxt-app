<template>
	<view class="all">
		...
		<view class="bottom">
			<view class="certificateConformity">
				查看《食用农产品合格证》
			</view>
			<view class="edit">
				<u-button type="primary">修改预约</u-button>
